...
//		}
//		count += 1;
//		printf(" 현재 %d자리 숫자야구가 준비되었습니다. 숫자야구의 자리수를 늘리시겠습니까? (최대 10자리, 늘리지 않을거면 1 입력) \n", count);
//		scanf_s("%d", &checker3);
//		if (checker3 == 1 || count == 10) {
//			printf("%d자리 숫자야구가 시작되었습니다.\n", count); break;
//		}
//
//	}
//
...
//
//	printf("%d회차 숫자야구 시작! \n", count2);
//	printf("%d자리 숫자를 차례로 입력하세요.(맨 처음 숫자는 무조건 1~9사이의 숫자입니다.)\n", count);
//	int i = 0;
//	while (i < count) {
//		printf("%d번째 숫자 \n", i + 1);
//		scanf_s("%d", &checker);
